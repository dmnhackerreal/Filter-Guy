...
reset = Fore.RESET # This is important to reset the color after printing
...
print(yellow)
time.sleep(0.1)
print(light_green + " programing by DMNHACKER      ")
...
try:
    get = int(input(blue + "inter 1 for give new code >>>"))
    if get == 1:
        print(blue + codereal)
        time.sleep(5)
    ...
    time.sleep(0.6)
    exit1 = input(green + "Enter key For back >>> ")
    print('ok')
    time.sleep(2)
    clear()
    time.sleep(2)
